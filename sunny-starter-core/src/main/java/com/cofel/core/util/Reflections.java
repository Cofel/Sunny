...
public abstract class Reflections {
    ...
    /**
     * 通过反射，获得Class定义中声明的泛型参数的类型，注意泛型必须定义在父类中，如无法找到，返回Object.class.
     * @param clazz class类
     * @return the 返回一个声明的泛型类型，如果没有，则返回Object.class.
     */
    ...
    /**
     * 通过反射，获得Class定义中声明的父类泛型参数的类型，如无法找到，返回Object.class
     * @param clazz class类
     * @param index 获取第几个泛型参数的类型，默认从0开始，即第一个
     * @return 返回第index个泛型参数类型
     */
    private static Class getClassGenericType(Class clazz, final int index) {
