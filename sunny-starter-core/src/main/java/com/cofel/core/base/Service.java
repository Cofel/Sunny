...
public interface Service<T> {
    ...
    /**
     * 根据实体的operate决定哪种操作,null属性也会保存,不会使用数据库默认值
     *
     * @param record
     * @return
     */
    ...
    /**
     * 批量操作，根据实体类的operate决定哪种操作，null属性也会保存，不会使用数据库默认值
     *
     * @param recordList
     * @return
     */
    List<T> persite(List<T> recordList);
     ...
     * @return
     */
    T persiteSelective(T record);

    /**
     * 批量操作，根据实体类的operate决定哪种操作，根据主键更新属性不为null的值
     *
     * @param recordList
     * @return
     */
    List<T> persiteSelective(List<T> recordList);
    ...
    /**
     * 根据实体类中的属性进行查询，只能有一个返回值，有多个结果抛出异常
     *
     * @param record
     * @return
     */
